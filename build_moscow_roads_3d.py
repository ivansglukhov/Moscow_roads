...
def build_tile_package(payload, tile_dir=TILE_DIR, tile_size_m=2500):
    ...
    for path in tile_dir.glob("tile-*.json"):
        path.unlink()
    for path in tile_dir.glob("tile-*.json.gz"):
        path.unlink()
